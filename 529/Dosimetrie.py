...
Mb35000V100mA279dot8VUcU = np.array([2.5, 5.0, 7.5, 10, 12.5, 15, 17.5, 20, 22.5, 25, 27.5, 30, 32.5, 35])
Mb35000V100mA279dot8VUcUE = np.array([0.05, 0.05, 0.05, 0.05, 0.07, 0.16, 0.34, 0.6, 1.03, 1.6, 2.27, 3.03, 3.85, 4.8])
...
Cu35000V100mA278dot8VUcU = np.array([2.5, 5.0, 7.5, 10, 12.5, 15, 17.5, 20, 22.5, 25, 27.5, 30, 32.5, 35])
Cu35000V100mA278dot8VUcUE = np.array([0.02, 0.02, 0.04, 0.15, 0.39, 0.72, 1.14, 1.56, 2.04, 2.52, 3.01, 3.54, 4.00, 4.45])
